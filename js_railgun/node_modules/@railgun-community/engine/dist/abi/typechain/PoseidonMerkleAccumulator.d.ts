...
export declare namespace PoseidonMerkleAccumulator {
    type TransactionConfigurationStruct = {
    ...
    type TransactionConfigurationStructOutput = [
        nullifiers: string[],
    ...
    type TreasuryFeeStruct = {
        tokenID: BytesLike;
        fee: BigNumberish;
    };
    type TreasuryFeeStructOutput = [tokenID: string, fee: bigint] & {
        tokenID: string;
        fee: bigint;
    };
    type StateUpdateStruct = {
...
export interface PoseidonMerkleAccumulatorInterface extends Interface {
    getFunction(nameOrSignature: "ZERO_VALUE" | "accumulatorNumber" | "accumulatorRoot" | "addVector" | "checkSafetyVectors" | "getInsertionAccumulatorNumberAndStartingIndex" | "initialize" | "nextLeafIndex" | "nullifiers" | "owner" | "registry" | "removeVector" | "renounceOwnership" | "rootHistory" | "safetyVector" | "tokenVault" | "transferOwnership" | "updateAccumulator" | "zeros"): FunctionFragment;
    getEvent(nameOrSignatureOrTopic: "AccumulatorStateUpdate" | "Initialized" | "OwnershipTransferred"): EventFragment;
    encodeFunctionData(functionFragment: "ZERO_VALUE", values?: undefined): string;
    encodeFunctionData(functionFragment: "accumulatorNumber", values?: undefined): string;
    encodeFunctionData(functionFragment: "accumulatorRoot", values?: undefined): string;
    ...
    encodeFunctionData(functionFragment: "getInsertionAccumulatorNumberAndStartingIndex", values: [BigNumberish]): string;
    ...
    encodeFunctionData(functionFragment: "updateAccumulator", values: [PoseidonMerkleAccumulator.StateUpdateStruct]): string;
    encodeFunctionData(functionFragment: "zeros", values: [BigNumberish]): string;
    decodeFunctionResult(functionFragment: "ZERO_VALUE", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "accumulatorNumber", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "accumulatorRoot", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "getInsertionAccumulatorNumberAndStartingIndex", data: BytesLike): Result;
...
export declare namespace AccumulatorStateUpdateEvent {
    type InputTuple = [
...
export interface PoseidonMerkleAccumulator extends BaseContract {
    ...
    getFunction(nameOrSignature: "accumulatorNumber"): TypedContractMethod<[], [bigint], "view">;
    getFunction(nameOrSignature: "accumulatorRoot"): TypedContractMethod<[], [string], "view">;
    ...
    getFunction(nameOrSignature: "getInsertionAccumulatorNumberAndStartingIndex"): TypedContractMethod<[
        _newCommitments: BigNumberish
    ], [
        [bigint, bigint]
    ], "view">;
    ...
    getEvent(key: "AccumulatorStateUpdate"): TypedContractEvent<AccumulatorStateUpdateEvent.InputTuple, AccumulatorStateUpdateEvent.OutputTuple, AccumulatorStateUpdateEvent.OutputObject>;
    getEvent(key: "Initialized"): TypedContractEvent<InitializedEvent.InputTuple, InitializedEvent.OutputTuple, InitializedEvent.OutputObject>;
    getEvent(key: "OwnershipTransferred"): TypedContractEvent<OwnershipTransferredEvent.InputTuple, OwnershipTransferredEvent.OutputTuple, OwnershipTransferredEvent.OutputObject>;
    filters: {
        "AccumulatorStateUpdate(tuple,uint32,uint224)": TypedContractEvent<AccumulatorStateUpdateEvent.InputTuple, AccumulatorStateUpdateEvent.OutputTuple, AccumulatorStateUpdateEvent.OutputObject>;
        AccumulatorStateUpdate: TypedContractEvent<AccumulatorStateUpdateEvent.InputTuple, AccumulatorStateUpdateEvent.OutputTuple, AccumulatorStateUpdateEvent.OutputObject>;
