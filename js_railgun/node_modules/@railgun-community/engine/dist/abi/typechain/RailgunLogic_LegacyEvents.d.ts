...
export interface RailgunLogic_LegacyEventsInterface extends Interface {
    getFunction(nameOrSignature: "SNARK_BYPASS" | "ZERO_VALUE" | "addToBlacklist" | "addVector" | "changeFee" | "changeTreasury" | "checkSafetyVectors" | "depositFee" | "generateDeposit" | "getFee" | "getTokenField" | "getVerificationKey" | "hashBoundParams" | "hashCommitment" | "hashLeftRight" | "initializeRailgunLogic" | "merkleRoot" | "nftFee" | "nullifiers" | "owner" | "removeFromBlacklist" | "removeVector" | "renounceOwnership" | "rootHistory" | "setVerificationKey" | "snarkSafetyVector" | "tokenBlacklist" | "transact" | "transferOwnership" | "treasury" | "treeNumber" | "verify" | "verifyProof" | "withdrawFee" | "zeros"): FunctionFragment;
    getEvent(nameOrSignatureOrTopic: "AddToBlacklist" | "CommitmentBatch" | "FeeChange" | "GeneratedCommitmentBatch" | "Nullifiers" | "OwnershipTransferred" | "RemoveFromBlacklist" | "TreasuryChange" | "VerifyingKeySet"): EventFragment;
    ...
    encodeFunctionData(functionFragment: "generateDeposit", values: [CommitmentPreimageStruct[], [BigNumberish, BigNumberish][]]): string;
    ...
    encodeFunctionData(functionFragment: "nullifiers", values: [BigNumberish, BigNumberish]): string;
    ...
    encodeFunctionData(functionFragment: "rootHistory", values: [BigNumberish, BigNumberish]): string;
    ...
    encodeFunctionData(functionFragment: "tokenBlacklist", values: [AddressLike]): string;
...
export declare namespace AddToBlacklistEvent {
...
export declare namespace RemoveFromBlacklistEvent {
    type InputTuple = [token: AddressLike];
    type OutputTuple = [token: string];
    interface OutputObject {
        token: string;
...
export interface RailgunLogic_LegacyEvents extends BaseContract {
    ...
    getFunction(nameOrSignature: "SNARK_BYPASS"): TypedContractMethod<[], [string], "view">;
    getFunction(nameOrSignature: "ZERO_VALUE"): TypedContractMethod<[], [bigint], "view">;
    getFunction(nameOrSignature: "addToBlacklist"): TypedContractMethod<[_tokens: AddressLike[]], [void], "nonpayable">;
    ...
    getFunction(nameOrSignature: "generateDeposit"): TypedContractMethod<[
        _notes: CommitmentPreimageStruct[],
        _encryptedRandom: [BigNumberish, BigNumberish][]
    ], [
        void
    ...
    getFunction(nameOrSignature: "getTokenField"): TypedContractMethod<[_tokenData: TokenDataStruct], [bigint], "view">;
    ...
    getFunction(nameOrSignature: "merkleRoot"): TypedContractMethod<[], [bigint], "view">;
    ...
    getFunction(nameOrSignature: "removeFromBlacklist"): TypedContractMethod<[_tokens: AddressLike[]], [void], "nonpayable">;
    ...
    getFunction(nameOrSignature: "tokenBlacklist"): TypedContractMethod<[arg0: AddressLike], [boolean], "view">;
    ...
    getFunction(nameOrSignature: "withdrawFee"): TypedContractMethod<[], [bigint], "view">;
    getFunction(nameOrSignature: "zeros"): TypedContractMethod<[arg0: BigNumberish], [bigint], "view">;
    getEvent(key: "AddToBlacklist"): TypedContractEvent<AddToBlacklistEvent.InputTuple, AddToBlacklistEvent.OutputTuple, AddToBlacklistEvent.OutputObject>;
    ...
    getEvent(key: "RemoveFromBlacklist"): TypedContractEvent<RemoveFromBlacklistEvent.InputTuple, RemoveFromBlacklistEvent.OutputTuple, RemoveFromBlacklistEvent.OutputObject>;
    ...
    filters: {
        "AddToBlacklist(address)": TypedContractEvent<AddToBlacklistEvent.InputTuple, AddToBlacklistEvent.OutputTuple, AddToBlacklistEvent.OutputObject>;
        AddToBlacklist: TypedContractEvent<AddToBlacklistEvent.InputTuple, AddToBlacklistEvent.OutputTuple, AddToBlacklistEvent.OutputObject>;
        ...
        "RemoveFromBlacklist(address)": TypedContractEvent<RemoveFromBlacklistEvent.InputTuple, RemoveFromBlacklistEvent.OutputTuple, RemoveFromBlacklistEvent.OutputObject>;
        RemoveFromBlacklist: TypedContractEvent<RemoveFromBlacklistEvent.InputTuple, RemoveFromBlacklistEvent.OutputTuple, RemoveFromBlacklistEvent.OutputObject>;
