...
export interface RailgunSmartWalletInterface extends Interface {
    getFunction(nameOrSignature: 'ZERO_VALUE' | 'addToBlocklist' | 'addVector' | 'changeFee' | 'changeTreasury' | 'checkSafetyVectors' | 'getFee' | 'getInsertionTreeNumberAndStartingIndex' | 'getTokenID' | 'getVerificationKey' | 'hashBoundParams' | 'hashCommitment' | 'hashLeftRight' | 'initializeRailgunLogic' | 'lastEventBlock' | 'merkleRoot' | 'nextLeafIndex' | 'nftFee' | 'nullifiers' | 'owner' | 'removeFromBlocklist' | 'removeVector' | 'renounceOwnership' | 'rootHistory' | 'setVerificationKey' | 'shield' | 'shieldFee' | 'snarkSafetyVector' | 'sumCommitments' | 'tokenBlocklist' | 'tokenIDMapping' | 'transact' | 'transferOwnership' | 'treasury' | 'treeNumber' | 'unshieldFee' | 'validateCommitmentPreimage' | 'validateTransaction' | 'verify' | 'verifyProof' | 'zeros'): FunctionFragment;
    getEvent(nameOrSignatureOrTopic: 'AddToBlocklist' | 'FeeChange' | 'Initialized' | 'Nullified' | 'OwnershipTransferred' | 'RemoveFromBlocklist' | 'Shield' | 'Transact' | 'TreasuryChange' | 'Unshield' | 'VerifyingKeySet' | 'CommitmentBatch' | 'GeneratedCommitmentBatch' | 'Nullifiers'): EventFragment;
    ...
    encodeFunctionData(functionFragment: 'changeFee', values: [BigNumberish, BigNumberish, BigNumberish]): string;
    ...
    encodeFunctionData(functionFragment: 'getFee', values: [BigNumberish, boolean, BigNumberish]): string;
    encodeFunctionData(functionFragment: 'getInsertionTreeNumberAndStartingIndex', values: [BigNumberish]): string;
    ...
    encodeFunctionData(functionFragment: 'initializeRailgunLogic', values: [AddressLike, BigNumberish, BigNumberish, BigNumberish, AddressLike]): string;
    ...
    encodeFunctionData(functionFragment: 'setVerificationKey', values: [BigNumberish, BigNumberish, VerifyingKeyStruct]): string;
    ...
    encodeFunctionData(functionFragment: 'verifyProof', values: [VerifyingKeyStruct, SnarkProofStruct, BigNumberish[]]): string;
    ...
    decodeFunctionResult(functionFragment: 'getInsertionTreeNumberAndStartingIndex', data: BytesLike): Result;
...
export declare namespace AddToBlocklistEvent {
...
export declare namespace FeeChangeEvent {
    type InputTuple = [
        shieldFee: BigNumberish,
        unshieldFee: BigNumberish,
        nftFee: BigNumberish
    ];
    type OutputTuple = [shieldFee: bigint, unshieldFee: bigint, nftFee: bigint];
    interface OutputObject {
        shieldFee: bigint;
        unshieldFee: bigint;
        nftFee: bigint;
...
export declare namespace NullifiedEvent {
    type InputTuple = [treeNumber: BigNumberish, nullifier: BytesLike[]];
    type OutputTuple = [treeNumber: bigint, nullifier: string[]];
    interface OutputObject {
        treeNumber: bigint;
        nullifier: string[];
    }
...
export declare namespace RemoveFromBlocklistEvent {
    type InputTuple = [token: AddressLike];
    type OutputTuple = [token: string];
    interface OutputObject {
        token: string;
...
export declare namespace ShieldEvent {
    type InputTuple = [
        treeNumber: BigNumberish,
...
export declare namespace TransactEvent {
    type InputTuple = [
        treeNumber: BigNumberish,
        startPosition: BigNumberish,
        hash: BytesLike[],
...
export declare namespace TreasuryChangeEvent {
...
export declare namespace UnshieldEvent {
    type InputTuple = [
        to: AddressLike,
        token: TokenDataStruct,
        amount: BigNumberish,
    ...
    type OutputTuple = [to: string, token: TokenDataStructOutput, amount: bigint, fee: bigint];
    interface OutputObject {
        to: string;
        token: TokenDataStructOutput;
        amount: bigint;
...
export declare namespace CommitmentBatchEvent {
    type InputTuple = [
        treeNumber: BigNumberish,
        startPosition: BigNumberish,
        hash: BigNumberish[],
...
export declare namespace GeneratedCommitmentBatchEvent {
    type InputTuple = [
        treeNumber: BigNumberish,
        startPosition: BigNumberish,
...
export declare namespace NullifiersEvent {
    type InputTuple = [treeNumber: BigNumberish, nullifier: BigNumberish[]];
    type OutputTuple = [treeNumber: bigint, nullifier: bigint[]];
    interface OutputObject {
        treeNumber: bigint;
        nullifier: bigint[];
    }
...
export interface RailgunSmartWallet extends BaseContract {
    ...
    getFunction(nameOrSignature: 'addToBlocklist'): TypedContractMethod<[_tokens: AddressLike[]], [void], 'nonpayable'>;
    getFunction(nameOrSignature: 'addVector'): TypedContractMethod<[vector: BigNumberish], [void], 'nonpayable'>;
    getFunction(nameOrSignature: 'changeFee'): TypedContractMethod<[
        _shieldFee: BigNumberish,
        _unshieldFee: BigNumberish,
        _nftFee: BigNumberish
    ], [
    ...
    getFunction(nameOrSignature: 'changeTreasury'): TypedContractMethod<[_treasury: AddressLike], [void], 'nonpayable'>;
    ...
    getFunction(nameOrSignature: 'getInsertionTreeNumberAndStartingIndex'): TypedContractMethod<[_newCommitments: BigNumberish], [[bigint, bigint]], 'view'>;
    getFunction(nameOrSignature: 'getTokenID'): TypedContractMethod<[_tokenData: TokenDataStruct], [string], 'view'>;
    ...
    getFunction(nameOrSignature: 'hashBoundParams'): TypedContractMethod<[_boundParams: BoundParamsStruct], [bigint], 'view'>;
    getFunction(nameOrSignature: 'hashCommitment'): TypedContractMethod<[_commitmentPreimage: CommitmentPreimageStruct], [string], 'view'>;
    getFunction(nameOrSignature: 'hashLeftRight'): TypedContractMethod<[_left: BytesLike, _right: BytesLike], [string], 'view'>;
    getFunction(nameOrSignature: 'initializeRailgunLogic'): TypedContractMethod<[
        _treasury: AddressLike,
        _shieldFee: BigNumberish,
        _unshieldFee: BigNumberish,
        _nftFee: BigNumberish,
    ...
    getFunction(nameOrSignature: 'nullifiers'): TypedContractMethod<[arg0: BigNumberish, arg1: BytesLike], [boolean], 'view'>;
    getFunction(nameOrSignature: 'owner'): TypedContractMethod<[], [string], 'view'>;
    getFunction(nameOrSignature: 'removeFromBlocklist'): TypedContractMethod<[_tokens: AddressLike[]], [void], 'nonpayable'>;
    getFunction(nameOrSignature: 'removeVector'): TypedContractMethod<[vector: BigNumberish], [void], 'nonpayable'>;
    getFunction(nameOrSignature: 'renounceOwnership'): TypedContractMethod<[], [void], 'nonpayable'>;
    getFunction(nameOrSignature: 'rootHistory'): TypedContractMethod<[arg0: BigNumberish, arg1: BytesLike], [boolean], 'view'>;
    ...
    getFunction(nameOrSignature: 'shield'): TypedContractMethod<[_shieldRequests: ShieldRequestStruct[]], [void], 'payable'>;
    getFunction(nameOrSignature: 'shieldFee'): TypedContractMethod<[], [bigint], 'view'>;
    getFunction(nameOrSignature: 'snarkSafetyVector'): TypedContractMethod<[arg0: BigNumberish], [boolean], 'view'>;
    getFunction(nameOrSignature: 'sumCommitments'): TypedContractMethod<[_transactions: TransactionStruct[]], [bigint], 'view'>;
    getFunction(nameOrSignature: 'tokenBlocklist'): TypedContractMethod<[arg0: AddressLike], [boolean], 'view'>;
    ...
    getFunction(nameOrSignature: 'transact'): TypedContractMethod<[_transactions: TransactionStruct[]], [void], 'payable'>;
    ...
    getFunction(nameOrSignature: 'validateCommitmentPreimage'): TypedContractMethod<[_note: CommitmentPreimageStruct], [[boolean, string]], 'view'>;
    getFunction(nameOrSignature: 'validateTransaction'): TypedContractMethod<[_transaction: TransactionStruct], [[boolean, string]], 'view'>;
    getFunction(nameOrSignature: 'verify'): TypedContractMethod<[_transaction: TransactionStruct], [boolean], 'view'>;
    ...
    getEvent(key: 'AddToBlocklist'): TypedContractEvent<AddToBlocklistEvent.InputTuple, AddToBlocklistEvent.OutputTuple, AddToBlocklistEvent.OutputObject>;
    getEvent(key: 'FeeChange'): TypedContractEvent<FeeChangeEvent.InputTuple, FeeChangeEvent.OutputTuple, FeeChangeEvent.OutputObject>;
    getEvent(key: 'Initialized'): TypedContractEvent<InitializedEvent.InputTuple, InitializedEvent.OutputTuple, InitializedEvent.OutputObject>;
    getEvent(key: 'Nullified'): TypedContractEvent<NullifiedEvent.InputTuple, NullifiedEvent.OutputTuple, NullifiedEvent.OutputObject>;
    getEvent(key: 'OwnershipTransferred'): TypedContractEvent<OwnershipTransferredEvent.InputTuple, OwnershipTransferredEvent.OutputTuple, OwnershipTransferredEvent.OutputObject>;
    getEvent(key: 'RemoveFromBlocklist'): TypedContractEvent<RemoveFromBlocklistEvent.InputTuple, RemoveFromBlocklistEvent.OutputTuple, RemoveFromBlocklistEvent.OutputObject>;
    getEvent(key: 'Shield'): TypedContractEvent<ShieldEvent.InputTuple, ShieldEvent.OutputTuple, ShieldEvent.OutputObject>;
    getEvent(key: 'Transact'): TypedContractEvent<TransactEvent.InputTuple, TransactEvent.OutputTuple, TransactEvent.OutputObject>;
    getEvent(key: 'TreasuryChange'): TypedContractEvent<TreasuryChangeEvent.InputTuple, TreasuryChangeEvent.OutputTuple, TreasuryChangeEvent.OutputObject>;
    getEvent(key: 'Unshield'): TypedContractEvent<UnshieldEvent.InputTuple, UnshieldEvent.OutputTuple, UnshieldEvent.OutputObject>;
    ...
    getEvent(key: 'CommitmentBatch'): TypedContractEvent<CommitmentBatchEvent.InputTuple, CommitmentBatchEvent.OutputTuple, CommitmentBatchEvent.OutputObject>;
    getEvent(key: 'GeneratedCommitmentBatch'): TypedContractEvent<GeneratedCommitmentBatchEvent.InputTuple, GeneratedCommitmentBatchEvent.OutputTuple, GeneratedCommitmentBatchEvent.OutputObject>;
    getEvent(key: 'Nullifiers'): TypedContractEvent<NullifiersEvent.InputTuple, NullifiersEvent.OutputTuple, NullifiersEvent.OutputObject>;
    filters: {
        'AddToBlocklist(address)': TypedContractEvent<AddToBlocklistEvent.InputTuple, AddToBlocklistEvent.OutputTuple, AddToBlocklistEvent.OutputObject>;
        AddToBlocklist: TypedContractEvent<AddToBlocklistEvent.InputTuple, AddToBlocklistEvent.OutputTuple, AddToBlocklistEvent.OutputObject>;
        'FeeChange(uint256,uint256,uint256)': TypedContractEvent<FeeChangeEvent.InputTuple, FeeChangeEvent.OutputTuple, FeeChangeEvent.OutputObject>;
        FeeChange: TypedContractEvent<FeeChangeEvent.InputTuple, FeeChangeEvent.OutputTuple, FeeChangeEvent.OutputObject>;
        'Initialized(uint8)': TypedContractEvent<InitializedEvent.InputTuple, InitializedEvent.OutputTuple, InitializedEvent.OutputObject>;
        Initialized: TypedContractEvent<InitializedEvent.InputTuple, InitializedEvent.OutputTuple, InitializedEvent.OutputObject>;
        'Nullified(uint16,bytes32[])': TypedContractEvent<NullifiedEvent.InputTuple, NullifiedEvent.OutputTuple, NullifiedEvent.OutputObject>;
        Nullified: TypedContractEvent<NullifiedEvent.InputTuple, NullifiedEvent.OutputTuple, NullifiedEvent.OutputObject>;
        'OwnershipTransferred(address,address)': TypedContractEvent<OwnershipTransferredEvent.InputTuple, OwnershipTransferredEvent.OutputTuple, OwnershipTransferredEvent.OutputObject>;
        OwnershipTransferred: TypedContractEvent<OwnershipTransferredEvent.InputTuple, OwnershipTransferredEvent.OutputTuple, OwnershipTransferredEvent.OutputObject>;
        'RemoveFromBlocklist(address)': TypedContractEvent<RemoveFromBlocklistEvent.InputTuple, RemoveFromBlocklistEvent.OutputTuple, RemoveFromBlocklistEvent.OutputObject>;
        RemoveFromBlocklist: TypedContractEvent<RemoveFromBlocklistEvent.InputTuple, RemoveFromBlocklistEvent.OutputTuple, RemoveFromBlocklistEvent.OutputObject>;
        'Shield(uint256,uint256,tuple[],tuple[],uint256[])': TypedContractEvent<ShieldEvent.InputTuple, ShieldEvent.OutputTuple, ShieldEvent.OutputObject>;
        Shield: TypedContractEvent<ShieldEvent.InputTuple, ShieldEvent.OutputTuple, ShieldEvent.OutputObject>;
        'Transact(uint256,uint256,bytes32[],tuple[])': TypedContractEvent<TransactEvent.InputTuple, TransactEvent.OutputTuple, TransactEvent.OutputObject>;
        Transact: TypedContractEvent<TransactEvent.InputTuple, TransactEvent.OutputTuple, TransactEvent.OutputObject>;
        'TreasuryChange(address)': TypedContractEvent<TreasuryChangeEvent.InputTuple, TreasuryChangeEvent.OutputTuple, TreasuryChangeEvent.OutputObject>;
        TreasuryChange: TypedContractEvent<TreasuryChangeEvent.InputTuple, TreasuryChangeEvent.OutputTuple, TreasuryChangeEvent.OutputObject>;
        'Unshield(address,tuple,uint256,uint256)': TypedContractEvent<UnshieldEvent.InputTuple, UnshieldEvent.OutputTuple, UnshieldEvent.OutputObject>;
        Unshield: TypedContractEvent<UnshieldEvent.InputTuple, UnshieldEvent.OutputTuple, UnshieldEvent.OutputObject>;
        ...
        'CommitmentBatch(uint256,uint256,uint256[],tuple[])': TypedContractEvent<CommitmentBatchEvent.InputTuple, CommitmentBatchEvent.OutputTuple, CommitmentBatchEvent.OutputObject>;
        CommitmentBatch: TypedContractEvent<CommitmentBatchEvent.InputTuple, CommitmentBatchEvent.OutputTuple, CommitmentBatchEvent.OutputObject>;
        'GeneratedCommitmentBatch(uint256,uint256,tuple[],uint256[2][])': TypedContractEvent<GeneratedCommitmentBatchEvent.InputTuple, GeneratedCommitmentBatchEvent.OutputTuple, GeneratedCommitmentBatchEvent.OutputObject>;
        GeneratedCommitmentBatch: TypedContractEvent<GeneratedCommitmentBatchEvent.InputTuple, GeneratedCommitmentBatchEvent.OutputTuple, GeneratedCommitmentBatchEvent.OutputObject>;
        'Nullifiers(uint256,uint256[])': TypedContractEvent<NullifiersEvent.InputTuple, NullifiersEvent.OutputTuple, NullifiersEvent.OutputObject>;
        Nullifiers: TypedContractEvent<NullifiersEvent.InputTuple, NullifiersEvent.OutputTuple, NullifiersEvent.OutputObject>;
    };
}
