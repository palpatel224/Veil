...
export interface RailgunSmartWallet_Legacy_PreMar23 extends BaseContract {
    ...
    getFunction(nameOrSignature: "getInsertionTreeNumberAndStartingIndex"): TypedContractMethod<[
        _newCommitments: BigNumberish
    ], [
        [bigint, bigint]
    ], "view">;
    ...
    getFunction(nameOrSignature: "nullifiers"): TypedContractMethod<[
        arg0: BigNumberish,
        arg1: BytesLike
    ], [
        boolean
    ...
    getFunction(nameOrSignature: "rootHistory"): TypedContractMethod<[
        arg0: BigNumberish,
        arg1: BytesLike
    ], [
        boolean
    ...
    getFunction(nameOrSignature: "shield"): TypedContractMethod<[
        _shieldRequests: ShieldRequestStruct[]
    ], [
        void
    ], "payable">;
    ...
    getFunction(nameOrSignature: "sumCommitments"): TypedContractMethod<[
        _transactions: TransactionStruct[]
    ], [
        bigint
    ], "view">;
    ...
    getFunction(nameOrSignature: "transact"): TypedContractMethod<[
        _transactions: TransactionStruct[]
    ], [
        void
    ], "payable">;
    ...
    getFunction(nameOrSignature: "validateCommitmentPreimage"): TypedContractMethod<[_note: CommitmentPreimageStruct], [boolean], "view">;
    getFunction(nameOrSignature: "validateTransaction"): TypedContractMethod<[_transaction: TransactionStruct], [boolean], "view">;
    ...
    filters: {
        ...
        "Shield(uint256,uint256,tuple[],tuple[])": TypedContractEvent<ShieldEvent.InputTuple, ShieldEvent.OutputTuple, ShieldEvent.OutputObject>;
