...
export declare namespace RelayAdapt {
    ...
    type CallStructOutput = [to: string, data: string, value: bigint] & {
        to: string;
        data: string;
        value: bigint;
    };
    type ActionDataStruct = {
        random: BytesLike;
        requireSuccess: boolean;
        minGasLimit: BigNumberish;
        calls: RelayAdapt.CallStruct[];
    };
    type ActionDataStructOutput = [
        random: string,
        requireSuccess: boolean,
        minGasLimit: bigint,
    ...
    type TokenTransferStructOutput = [
        token: TokenDataStructOutput,
        to: string,
        value: bigint
    ] & {
...
export interface RelayAdaptInterface extends Interface {
    getFunction(nameOrSignature: "getAdaptParams" | "multicall" | "railgun" | "relay" | "shield" | "transfer" | "unwrapBase" | "wBase" | "wrapBase"): FunctionFragment;
    getEvent(nameOrSignatureOrTopic: "CallError"): EventFragment;
    encodeFunctionData(functionFragment: "getAdaptParams", values: [TransactionStruct[], RelayAdapt.ActionDataStruct]): string;
    encodeFunctionData(functionFragment: "multicall", values: [boolean, RelayAdapt.CallStruct[]]): string;
    encodeFunctionData(functionFragment: "railgun", values?: undefined): string;
    encodeFunctionData(functionFragment: "relay", values: [TransactionStruct[], RelayAdapt.ActionDataStruct]): string;
    encodeFunctionData(functionFragment: "shield", values: [ShieldRequestStruct[]]): string;
    encodeFunctionData(functionFragment: "transfer", values: [RelayAdapt.TokenTransferStruct[]]): string;
    encodeFunctionData(functionFragment: "unwrapBase", values: [BigNumberish]): string;
    encodeFunctionData(functionFragment: "wBase", values?: undefined): string;
    encodeFunctionData(functionFragment: "wrapBase", values: [BigNumberish]): string;
...
export declare namespace CallErrorEvent {
    type InputTuple = [callIndex: BigNumberish, revertReason: BytesLike];
    type OutputTuple = [callIndex: bigint, revertReason: string];
...
export interface RelayAdapt extends BaseContract {
    ...
    getFunction(nameOrSignature: "getAdaptParams"): TypedContractMethod<[
        _transactions: TransactionStruct[],
        _actionData: RelayAdapt.ActionDataStruct
    ], [
        string
    ...
    getFunction(nameOrSignature: "railgun"): TypedContractMethod<[], [string], "view">;
    ...
    getFunction(nameOrSignature: "unwrapBase"): TypedContractMethod<[_amount: BigNumberish], [void], "nonpayable">;
    getFunction(nameOrSignature: "wBase"): TypedContractMethod<[], [string], "view">;
    getFunction(nameOrSignature: "wrapBase"): TypedContractMethod<[_amount: BigNumberish], [void], "nonpayable">;
    getEvent(key: "CallError"): TypedContractEvent<CallErrorEvent.InputTuple, CallErrorEvent.OutputTuple, CallErrorEvent.OutputObject>;
    filters: {
        "CallError(uint256,bytes)": TypedContractEvent<CallErrorEvent.InputTuple, CallErrorEvent.OutputTuple, CallErrorEvent.OutputObject>;
        CallError: TypedContractEvent<CallErrorEvent.InputTuple, CallErrorEvent.OutputTuple, CallErrorEvent.OutputObject>;
    };
}
