...
import type { RailgunSmartWallet, RailgunSmartWalletInterface } from "../RailgunSmartWallet";
export declare class RailgunSmartWallet__factory {
    ...
    static connect(address: string, runner?: ContractRunner | null): RailgunSmartWallet;
}
