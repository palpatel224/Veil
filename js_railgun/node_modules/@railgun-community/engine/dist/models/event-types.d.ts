import { Commitment, Nullifier, RailgunTransactionV2, RailgunTransactionV3 } from './formatted-types';
...
export type QuickSyncEvents = (txidVersion: TXIDVersion, chain: Chain, startingBlock: number) => Promise<AccumulatedEvents>;
export type EventsCommitmentListener = (txidVersion: TXIDVersion, events: CommitmentEvent[]) => Promise<void>;
