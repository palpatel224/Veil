...
class WalletInfo {
    ...
    static getEncodedWalletSource(walletSource) {
        if (!walletSource) {
            return '';
        }
     ...
     */
    static encodeWalletSource(walletSource) {
    ...
    static decodeWalletSource(bytes) {
