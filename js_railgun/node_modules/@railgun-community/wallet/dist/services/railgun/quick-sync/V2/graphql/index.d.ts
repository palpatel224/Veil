...
export type CommitmentsQuery = {
    commitments: Array<(Pick<LegacyGeneratedCommitment, 'id' | 'treeNumber' | 'batchStartTreePosition' | 'treePosition' | 'blockNumber' | 'transactionHash' | 'blockTimestamp' | 'commitmentType' | 'hash' | 'encryptedRandom'> & {
