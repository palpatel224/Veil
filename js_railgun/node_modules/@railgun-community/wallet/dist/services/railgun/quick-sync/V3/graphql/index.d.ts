...
export type RailgunTransaction_orderBy = 'id' | 'blockNumber' | 'transactionHash' | 'nullifiers' | 'commitments' | 'boundParamsHash' | 'hasUnshield' | 'utxoTreeIn' | 'utxoTreeOut' | 'utxoBatchStartPositionOut' | 'unshieldToken' | 'unshieldToken__id' | 'unshieldToken__tokenType' | 'unshieldToken__tokenAddress' | 'unshieldToken__tokenSubID' | 'unshieldToAddress' | 'unshieldValue' | 'blockTimestamp' | 'verificationHash';
...
export type QueryResolvers<ContextType = MeshContext, ParentType extends ResolversParentTypes['Query'] = ResolversParentTypes['Query']> = ResolversObject<{
    ...
    railgunTransaction?: Resolver<Maybe<ResolversTypes['RailgunTransaction']>, ParentType, ContextType, RequireFields<QueryrailgunTransactionArgs, 'id' | 'subgraphError'>>;
    railgunTransactions?: Resolver<Array<ResolversTypes['RailgunTransaction']>, ParentType, ContextType, RequireFields<QueryrailgunTransactionsArgs, 'skip' | 'first' | 'subgraphError'>>;
...
export type RailgunTransactionResolvers<ContextType = MeshContext, ParentType extends ResolversParentTypes['RailgunTransaction'] = ResolversParentTypes['RailgunTransaction']> = ResolversObject<{
    id?: Resolver<ResolversTypes['Bytes'], ParentType, ContextType>;
    blockNumber?: Resolver<ResolversTypes['BigInt'], ParentType, ContextType>;
    transactionHash?: Resolver<ResolversTypes['Bytes'], ParentType, ContextType>;
...
export type SubscriptionResolvers<ContextType = MeshContext, ParentType extends ResolversParentTypes['Subscription'] = ResolversParentTypes['Subscription']> = ResolversObject<{
    ...
    railgunTransaction?: SubscriptionResolver<Maybe<ResolversTypes['RailgunTransaction']>, 'railgunTransaction', ParentType, ContextType, RequireFields<SubscriptionrailgunTransactionArgs, 'id' | 'subgraphError'>>;
    railgunTransactions?: SubscriptionResolver<Array<ResolversTypes['RailgunTransaction']>, 'railgunTransactions', ParentType, ContextType, RequireFields<SubscriptionrailgunTransactionsArgs, 'skip' | 'first' | 'subgraphError'>>;
...
export declare function getBuiltGraphSDK<TGlobalContext = any, TOperationContext = any>(globalContext?: TGlobalContext): {
    ...
    RailgunTransactions(variables?: Exact<{
        blockNumber?: InputMaybe<string> | undefined;
    }> | undefined, options?: TOperationContext | undefined): Promise<RailgunTransactionsQuery>;
};
...
export type RailgunTransactionsQuery = {
    railgunTransactions: Array<Pick<RailgunTransaction, 'id' | 'blockNumber' | 'blockTimestamp' | 'transactionHash' | 'nullifiers' | 'commitments' | 'boundParamsHash' | 'hasUnshield' | 'utxoTreeIn' | 'utxoTreeOut' | 'utxoBatchStartPositionOut' | 'unshieldToAddress' | 'unshieldValue' | 'verificationHash'> & {
...
export declare const RailgunTransactionsDocument: DocumentNode<RailgunTransactionsQuery, Exact<{
    blockNumber?: InputMaybe<string> | undefined;
}>>;
...
export declare function getSdk<C, E>(requester: Requester<C, E>): {
    ...
    RailgunTransactions(variables?: RailgunTransactionsQueryVariables, options?: C): Promise<RailgunTransactionsQuery>;
};
