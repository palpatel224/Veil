...
export declare namespace TxsArbitrumTypes {
    type Maybe<T> = T | null;
    ...
    type QuerytokenByIdArgs = {
        id: Scalars['String'];
    };
    type QuerytokenByUniqueInputArgs = {
        where: WhereIdInput;
    };
    ...
    type QuerycommitmentPreimageByIdArgs = {
        id: Scalars['String'];
    };
    type QuerycommitmentPreimageByUniqueInputArgs = {
        where: WhereIdInput;
    };
    type QuerycommitmentPreimagesConnectionArgs = {
    ...
    type QueryciphertextByIdArgs = {
        id: Scalars['String'];
    };
    type QueryciphertextByUniqueInputArgs = {
        where: WhereIdInput;
    };
    type QueryciphertextsConnectionArgs = {
    ...
    type QuerylegacyCommitmentCiphertextByIdArgs = {
        id: Scalars['String'];
    };
    type QuerylegacyCommitmentCiphertextByUniqueInputArgs = {
        where: WhereIdInput;
    };
    type QuerylegacyCommitmentCiphertextsConnectionArgs = {
    ...
    type QuerycommitmentCiphertextByIdArgs = {
        id: Scalars['String'];
    };
    type QuerycommitmentCiphertextByUniqueInputArgs = {
        where: WhereIdInput;
    };
    type QuerycommitmentCiphertextsConnectionArgs = {
    ...
    type QuerylegacyGeneratedCommitmentByIdArgs = {
        id: Scalars['String'];
    };
    type QuerylegacyGeneratedCommitmentByUniqueInputArgs = {
        where: WhereIdInput;
    };
    type QuerylegacyGeneratedCommitmentsConnectionArgs = {
    ...
    type QuerycommitmentsConnectionArgs = {
    ...
    type QuerylegacyEncryptedCommitmentByIdArgs = {
        id: Scalars['String'];
    };
    type QuerylegacyEncryptedCommitmentByUniqueInputArgs = {
        where: WhereIdInput;
    };
    type QuerylegacyEncryptedCommitmentsConnectionArgs = {
    ...
    type QueryshieldCommitmentByIdArgs = {
        id: Scalars['String'];
    };
    type QueryshieldCommitmentByUniqueInputArgs = {
        where: WhereIdInput;
    };
    type QueryshieldCommitmentsConnectionArgs = {
    ...
    type QuerytransactCommitmentByIdArgs = {
        id: Scalars['String'];
    };
    type QuerytransactCommitmentByUniqueInputArgs = {
        where: WhereIdInput;
    };
    type QuerytransactCommitmentsConnectionArgs = {
    ...
    type QueryunshieldByIdArgs = {
        id: Scalars['String'];
    };
    type QueryunshieldByUniqueInputArgs = {
        where: WhereIdInput;
    };
    type QueryunshieldsConnectionArgs = {
    ...
    type QuerynullifierByIdArgs = {
        id: Scalars['String'];
    };
    type QuerynullifierByUniqueInputArgs = {
        where: WhereIdInput;
    };
    type QuerynullifiersConnectionArgs = {
    ...
    type QuerytransactionByUniqueInputArgs = {
        where: WhereIdInput;
    };
    ...
    type QueryverificationHashByIdArgs = {
        id: Scalars['String'];
    };
    type QueryverificationHashByUniqueInputArgs = {
        where: WhereIdInput;
    };
    type QueryverificationHashesConnectionArgs = {
        orderBy: Array<VerificationHashOrderByInput>;
        after?: InputMaybe<Scalars['String']>;
        first?: InputMaybe<Scalars['Int']>;
        where?: InputMaybe<VerificationHashWhereInput>;
    };
    type QuerycommitmentBatchEventNewsArgs = {
        where?: InputMaybe<CommitmentBatchEventNewWhereInput>;
        orderBy?: InputMaybe<Array<CommitmentBatchEventNewOrderByInput>>;
        offset?: InputMaybe<Scalars['Int']>;
        limit?: InputMaybe<Scalars['Int']>;
    };
    type QuerycommitmentBatchEventNewByIdArgs = {
        id: Scalars['String'];
    };
    type QuerycommitmentBatchEventNewByUniqueInputArgs = {
        where: WhereIdInput;
    };
    type QuerycommitmentBatchEventNewsConnectionArgs = {
    ...
    type TokenOrderByInput = 'id_ASC' | 'id_DESC' | 'id_ASC_NULLS_FIRST' | 'id_DESC_NULLS_LAST' | 'tokenType_ASC' | 'tokenType_DESC' | 'tokenType_ASC_NULLS_FIRST' | 'tokenType_DESC_NULLS_LAST' | 'tokenAddress_ASC' | 'tokenAddress_DESC' | 'tokenAddress_ASC_NULLS_FIRST' | 'tokenAddress_DESC_NULLS_LAST' | 'tokenSubID_ASC' | 'tokenSubID_DESC' | 'tokenSubID_ASC_NULLS_FIRST' | 'tokenSubID_DESC_NULLS_LAST';
    type WhereIdInput = {
        id: Scalars['String'];
    };
    ...
    type CommitmentPreimageWhereInput = {
        id_isNull?: InputMaybe<Scalars['Boolean']>;
        id_eq?: InputMaybe<Scalars['String']>;
        id_not_eq?: InputMaybe<Scalars['String']>;
        id_gt?: InputMaybe<Scalars['String']>;
    ...
    type CommitmentPreimageOrderByInput = 'id_ASC' | 'id_DESC' | 'id_ASC_NULLS_FIRST' | 'id_DESC_NULLS_LAST' | 'npk_ASC' | 'npk_DESC' | 'npk_ASC_NULLS_FIRST' | 'npk_DESC_NULLS_LAST' | 'token_id_ASC' | 'token_id_DESC' | 'token_id_ASC_NULLS_FIRST' | 'token_id_DESC_NULLS_LAST' | 'token_tokenType_ASC' | 'token_tokenType_DESC' | 'token_tokenType_ASC_NULLS_FIRST' | 'token_tokenType_DESC_NULLS_LAST' | 'token_tokenAddress_ASC' | 'token_tokenAddress_DESC' | 'token_tokenAddress_ASC_NULLS_FIRST' | 'token_tokenAddress_DESC_NULLS_LAST' | 'token_tokenSubID_ASC' | 'token_tokenSubID_DESC' | 'token_tokenSubID_ASC_NULLS_FIRST' | 'token_tokenSubID_DESC_NULLS_LAST' | 'value_ASC' | 'value_DESC' | 'value_ASC_NULLS_FIRST' | 'value_DESC_NULLS_LAST';
    type CommitmentPreimagesConnection = {
        edges: Array<CommitmentPreimageEdge>;
        pageInfo: PageInfo;
        totalCount: Scalars['Int'];
    };
    type CommitmentPreimageEdge = {
    ...
    type CiphertextOrderByInput = 'id_ASC' | 'id_DESC' | 'id_ASC_NULLS_FIRST' | 'id_DESC_NULLS_LAST' | 'iv_ASC' | 'iv_DESC' | 'iv_ASC_NULLS_FIRST' | 'iv_DESC_NULLS_LAST' | 'tag_ASC' | 'tag_DESC' | 'tag_ASC_NULLS_FIRST' | 'tag_DESC_NULLS_LAST';
    type CiphertextsConnection = {
    ...
    type LegacyCommitmentCiphertextWhereInput = {
        id_isNull?: InputMaybe<Scalars['Boolean']>;
        id_eq?: InputMaybe<Scalars['String']>;
        id_not_eq?: InputMaybe<Scalars['String']>;
        id_gt?: InputMaybe<Scalars['String']>;
    ...
    type LegacyCommitmentCiphertextOrderByInput = 'id_ASC' | 'id_DESC' | 'id_ASC_NULLS_FIRST' | 'id_DESC_NULLS_LAST' | 'ciphertext_id_ASC' | 'ciphertext_id_DESC' | 'ciphertext_id_ASC_NULLS_FIRST' | 'ciphertext_id_DESC_NULLS_LAST' | 'ciphertext_iv_ASC' | 'ciphertext_iv_DESC' | 'ciphertext_iv_ASC_NULLS_FIRST' | 'ciphertext_iv_DESC_NULLS_LAST' | 'ciphertext_tag_ASC' | 'ciphertext_tag_DESC' | 'ciphertext_tag_ASC_NULLS_FIRST' | 'ciphertext_tag_DESC_NULLS_LAST';
    type LegacyCommitmentCiphertextsConnection = {
        edges: Array<LegacyCommitmentCiphertextEdge>;
        pageInfo: PageInfo;
        totalCount: Scalars['Int'];
    };
    type LegacyCommitmentCiphertextEdge = {
    ...
    type CommitmentCiphertextWhereInput = {
        id_isNull?: InputMaybe<Scalars['Boolean']>;
        id_eq?: InputMaybe<Scalars['String']>;
        id_not_eq?: InputMaybe<Scalars['String']>;
        id_gt?: InputMaybe<Scalars['String']>;
    ...
    type CommitmentCiphertextOrderByInput = 'id_ASC' | 'id_DESC' | 'id_ASC_NULLS_FIRST' | 'id_DESC_NULLS_LAST' | 'ciphertext_id_ASC' | 'ciphertext_id_DESC' | 'ciphertext_id_ASC_NULLS_FIRST' | 'ciphertext_id_DESC_NULLS_LAST' | 'ciphertext_iv_ASC' | 'ciphertext_iv_DESC' | 'ciphertext_iv_ASC_NULLS_FIRST' | 'ciphertext_iv_DESC_NULLS_LAST' | 'ciphertext_tag_ASC' | 'ciphertext_tag_DESC' | 'ciphertext_tag_ASC_NULLS_FIRST' | 'ciphertext_tag_DESC_NULLS_LAST' | 'blindedSenderViewingKey_ASC' | 'blindedSenderViewingKey_DESC' | 'blindedSenderViewingKey_ASC_NULLS_FIRST' | 'blindedSenderViewingKey_DESC_NULLS_LAST' | 'blindedReceiverViewingKey_ASC' | 'blindedReceiverViewingKey_DESC' | 'blindedReceiverViewingKey_ASC_NULLS_FIRST' | 'blindedReceiverViewingKey_DESC_NULLS_LAST' | 'annotationData_ASC' | 'annotationData_DESC' | 'annotationData_ASC_NULLS_FIRST' | 'annotationData_DESC_NULLS_LAST' | 'memo_ASC' | 'memo_DESC' | 'memo_ASC_NULLS_FIRST' | 'memo_DESC_NULLS_LAST';
    type CommitmentCiphertextsConnection = {
        edges: Array<CommitmentCiphertextEdge>;
        pageInfo: PageInfo;
        totalCount: Scalars['Int'];
    };
    type CommitmentCiphertextEdge = {
    ...
    type LegacyGeneratedCommitmentWhereInput = {
        id_isNull?: InputMaybe<Scalars['Boolean']>;
        id_eq?: InputMaybe<Scalars['String']>;
        id_not_eq?: InputMaybe<Scalars['String']>;
        id_gt?: InputMaybe<Scalars['String']>;
    ...
    type LegacyGeneratedCommitmentOrderByInput = 'id_ASC' | 'id_DESC' | 'id_ASC_NULLS_FIRST' | 'id_DESC_NULLS_LAST' | 'blockNumber_ASC' | 'blockNumber_DESC' | 'blockNumber_ASC_NULLS_FIRST' | 'blockNumber_DESC_NULLS_LAST' | 'blockTimestamp_ASC' | 'blockTimestamp_DESC' | 'blockTimestamp_ASC_NULLS_FIRST' | 'blockTimestamp_DESC_NULLS_LAST' | 'transactionHash_ASC' | 'transactionHash_DESC' | 'transactionHash_ASC_NULLS_FIRST' | 'transactionHash_DESC_NULLS_LAST' | 'treeNumber_ASC' | 'treeNumber_DESC' | 'treeNumber_ASC_NULLS_FIRST' | 'treeNumber_DESC_NULLS_LAST' | 'batchStartTreePosition_ASC' | 'batchStartTreePosition_DESC' | 'batchStartTreePosition_ASC_NULLS_FIRST' | 'batchStartTreePosition_DESC_NULLS_LAST' | 'treePosition_ASC' | 'treePosition_DESC' | 'treePosition_ASC_NULLS_FIRST' | 'treePosition_DESC_NULLS_LAST' | 'commitmentType_ASC' | 'commitmentType_DESC' | 'commitmentType_ASC_NULLS_FIRST' | 'commitmentType_DESC_NULLS_LAST' | 'hash_ASC' | 'hash_DESC' | 'hash_ASC_NULLS_FIRST' | 'hash_DESC_NULLS_LAST' | 'preimage_id_ASC' | 'preimage_id_DESC' | 'preimage_id_ASC_NULLS_FIRST' | 'preimage_id_DESC_NULLS_LAST' | 'preimage_npk_ASC' | 'preimage_npk_DESC' | 'preimage_npk_ASC_NULLS_FIRST' | 'preimage_npk_DESC_NULLS_LAST' | 'preimage_value_ASC' | 'preimage_value_DESC' | 'preimage_value_ASC_NULLS_FIRST' | 'preimage_value_DESC_NULLS_LAST';
    type LegacyGeneratedCommitmentsConnection = {
        edges: Array<LegacyGeneratedCommitmentEdge>;
        pageInfo: PageInfo;
        totalCount: Scalars['Int'];
    };
    type LegacyGeneratedCommitmentEdge = {
    ...
    type CommitmentOrderByInput = 'id_ASC' | 'id_DESC' | 'id_ASC_NULLS_FIRST' | 'id_DESC_NULLS_LAST' | 'blockNumber_ASC' | 'blockNumber_DESC' | 'blockNumber_ASC_NULLS_FIRST' | 'blockNumber_DESC_NULLS_LAST' | 'blockTimestamp_ASC' | 'blockTimestamp_DESC' | 'blockTimestamp_ASC_NULLS_FIRST' | 'blockTimestamp_DESC_NULLS_LAST' | 'transactionHash_ASC' | 'transactionHash_DESC' | 'transactionHash_ASC_NULLS_FIRST' | 'transactionHash_DESC_NULLS_LAST' | 'treeNumber_ASC' | 'treeNumber_DESC' | 'treeNumber_ASC_NULLS_FIRST' | 'treeNumber_DESC_NULLS_LAST' | 'batchStartTreePosition_ASC' | 'batchStartTreePosition_DESC' | 'batchStartTreePosition_ASC_NULLS_FIRST' | 'batchStartTreePosition_DESC_NULLS_LAST' | 'treePosition_ASC' | 'treePosition_DESC' | 'treePosition_ASC_NULLS_FIRST' | 'treePosition_DESC_NULLS_LAST' | 'commitmentType_ASC' | 'commitmentType_DESC' | 'commitmentType_ASC_NULLS_FIRST' | 'commitmentType_DESC_NULLS_LAST' | 'hash_ASC' | 'hash_DESC' | 'hash_ASC_NULLS_FIRST' | 'hash_DESC_NULLS_LAST' | '_type_ASC' | '_type_DESC';
    type CommitmentsConnection = {
    ...
    type LegacyEncryptedCommitmentWhereInput = {
        id_isNull?: InputMaybe<Scalars['Boolean']>;
        id_eq?: InputMaybe<Scalars['String']>;
        id_not_eq?: InputMaybe<Scalars['String']>;
        id_gt?: InputMaybe<Scalars['String']>;
    ...
    type LegacyEncryptedCommitmentOrderByInput = 'id_ASC' | 'id_DESC' | 'id_ASC_NULLS_FIRST' | 'id_DESC_NULLS_LAST' | 'blockNumber_ASC' | 'blockNumber_DESC' | 'blockNumber_ASC_NULLS_FIRST' | 'blockNumber_DESC_NULLS_LAST' | 'blockTimestamp_ASC' | 'blockTimestamp_DESC' | 'blockTimestamp_ASC_NULLS_FIRST' | 'blockTimestamp_DESC_NULLS_LAST' | 'transactionHash_ASC' | 'transactionHash_DESC' | 'transactionHash_ASC_NULLS_FIRST' | 'transactionHash_DESC_NULLS_LAST' | 'treeNumber_ASC' | 'treeNumber_DESC' | 'treeNumber_ASC_NULLS_FIRST' | 'treeNumber_DESC_NULLS_LAST' | 'batchStartTreePosition_ASC' | 'batchStartTreePosition_DESC' | 'batchStartTreePosition_ASC_NULLS_FIRST' | 'batchStartTreePosition_DESC_NULLS_LAST' | 'treePosition_ASC' | 'treePosition_DESC' | 'treePosition_ASC_NULLS_FIRST' | 'treePosition_DESC_NULLS_LAST' | 'commitmentType_ASC' | 'commitmentType_DESC' | 'commitmentType_ASC_NULLS_FIRST' | 'commitmentType_DESC_NULLS_LAST' | 'hash_ASC' | 'hash_DESC' | 'hash_ASC_NULLS_FIRST' | 'hash_DESC_NULLS_LAST' | 'ciphertext_id_ASC' | 'ciphertext_id_DESC' | 'ciphertext_id_ASC_NULLS_FIRST' | 'ciphertext_id_DESC_NULLS_LAST';
    type LegacyEncryptedCommitmentsConnection = {
        edges: Array<LegacyEncryptedCommitmentEdge>;
        pageInfo: PageInfo;
        totalCount: Scalars['Int'];
    };
    type LegacyEncryptedCommitmentEdge = {
    ...
    type ShieldCommitmentWhereInput = {
        id_isNull?: InputMaybe<Scalars['Boolean']>;
        id_eq?: InputMaybe<Scalars['String']>;
        id_not_eq?: InputMaybe<Scalars['String']>;
        id_gt?: InputMaybe<Scalars['String']>;
    ...
    type ShieldCommitmentOrderByInput = 'id_ASC' | 'id_DESC' | 'id_ASC_NULLS_FIRST' | 'id_DESC_NULLS_LAST' | 'blockNumber_ASC' | 'blockNumber_DESC' | 'blockNumber_ASC_NULLS_FIRST' | 'blockNumber_DESC_NULLS_LAST' | 'blockTimestamp_ASC' | 'blockTimestamp_DESC' | 'blockTimestamp_ASC_NULLS_FIRST' | 'blockTimestamp_DESC_NULLS_LAST' | 'transactionHash_ASC' | 'transactionHash_DESC' | 'transactionHash_ASC_NULLS_FIRST' | 'transactionHash_DESC_NULLS_LAST' | 'treeNumber_ASC' | 'treeNumber_DESC' | 'treeNumber_ASC_NULLS_FIRST' | 'treeNumber_DESC_NULLS_LAST' | 'batchStartTreePosition_ASC' | 'batchStartTreePosition_DESC' | 'batchStartTreePosition_ASC_NULLS_FIRST' | 'batchStartTreePosition_DESC_NULLS_LAST' | 'treePosition_ASC' | 'treePosition_DESC' | 'treePosition_ASC_NULLS_FIRST' | 'treePosition_DESC_NULLS_LAST' | 'commitmentType_ASC' | 'commitmentType_DESC' | 'commitmentType_ASC_NULLS_FIRST' | 'commitmentType_DESC_NULLS_LAST' | 'hash_ASC' | 'hash_DESC' | 'hash_ASC_NULLS_FIRST' | 'hash_DESC_NULLS_LAST' | 'preimage_id_ASC' | 'preimage_id_DESC' | 'preimage_id_ASC_NULLS_FIRST' | 'preimage_id_DESC_NULLS_LAST' | 'preimage_npk_ASC' | 'preimage_npk_DESC' | 'preimage_npk_ASC_NULLS_FIRST' | 'preimage_npk_DESC_NULLS_LAST' | 'preimage_value_ASC' | 'preimage_value_DESC' | 'preimage_value_ASC_NULLS_FIRST' | 'preimage_value_DESC_NULLS_LAST' | 'shieldKey_ASC' | 'shieldKey_DESC' | 'shieldKey_ASC_NULLS_FIRST' | 'shieldKey_DESC_NULLS_LAST' | 'fee_ASC' | 'fee_DESC' | 'fee_ASC_NULLS_FIRST' | 'fee_DESC_NULLS_LAST';
    type ShieldCommitmentsConnection = {
        edges: Array<ShieldCommitmentEdge>;
        pageInfo: PageInfo;
        totalCount: Scalars['Int'];
    };
    type ShieldCommitmentEdge = {
    ...
    type TransactCommitmentWhereInput = {
        id_isNull?: InputMaybe<Scalars['Boolean']>;
        id_eq?: InputMaybe<Scalars['String']>;
        id_not_eq?: InputMaybe<Scalars['String']>;
        id_gt?: InputMaybe<Scalars['String']>;
    ...
    type TransactCommitmentOrderByInput = 'id_ASC' | 'id_DESC' | 'id_ASC_NULLS_FIRST' | 'id_DESC_NULLS_LAST' | 'blockNumber_ASC' | 'blockNumber_DESC' | 'blockNumber_ASC_NULLS_FIRST' | 'blockNumber_DESC_NULLS_LAST' | 'blockTimestamp_ASC' | 'blockTimestamp_DESC' | 'blockTimestamp_ASC_NULLS_FIRST' | 'blockTimestamp_DESC_NULLS_LAST' | 'transactionHash_ASC' | 'transactionHash_DESC' | 'transactionHash_ASC_NULLS_FIRST' | 'transactionHash_DESC_NULLS_LAST' | 'treeNumber_ASC' | 'treeNumber_DESC' | 'treeNumber_ASC_NULLS_FIRST' | 'treeNumber_DESC_NULLS_LAST' | 'batchStartTreePosition_ASC' | 'batchStartTreePosition_DESC' | 'batchStartTreePosition_ASC_NULLS_FIRST' | 'batchStartTreePosition_DESC_NULLS_LAST' | 'treePosition_ASC' | 'treePosition_DESC' | 'treePosition_ASC_NULLS_FIRST' | 'treePosition_DESC_NULLS_LAST' | 'commitmentType_ASC' | 'commitmentType_DESC' | 'commitmentType_ASC_NULLS_FIRST' | 'commitmentType_DESC_NULLS_LAST' | 'hash_ASC' | 'hash_DESC' | 'hash_ASC_NULLS_FIRST' | 'hash_DESC_NULLS_LAST' | 'ciphertext_id_ASC' | 'ciphertext_id_DESC' | 'ciphertext_id_ASC_NULLS_FIRST' | 'ciphertext_id_DESC_NULLS_LAST' | 'ciphertext_blindedSenderViewingKey_ASC' | 'ciphertext_blindedSenderViewingKey_DESC' | 'ciphertext_blindedSenderViewingKey_ASC_NULLS_FIRST' | 'ciphertext_blindedSenderViewingKey_DESC_NULLS_LAST' | 'ciphertext_blindedReceiverViewingKey_ASC' | 'ciphertext_blindedReceiverViewingKey_DESC' | 'ciphertext_blindedReceiverViewingKey_ASC_NULLS_FIRST' | 'ciphertext_blindedReceiverViewingKey_DESC_NULLS_LAST' | 'ciphertext_annotationData_ASC' | 'ciphertext_annotationData_DESC' | 'ciphertext_annotationData_ASC_NULLS_FIRST' | 'ciphertext_annotationData_DESC_NULLS_LAST' | 'ciphertext_memo_ASC' | 'ciphertext_memo_DESC' | 'ciphertext_memo_ASC_NULLS_FIRST' | 'ciphertext_memo_DESC_NULLS_LAST';
    type TransactCommitmentsConnection = {
        edges: Array<TransactCommitmentEdge>;
        pageInfo: PageInfo;
        totalCount: Scalars['Int'];
    };
    type TransactCommitmentEdge = {
    ...
    type UnshieldOrderByInput = 'id_ASC' | 'id_DESC' | 'id_ASC_NULLS_FIRST' | 'id_DESC_NULLS_LAST' | 'blockNumber_ASC' | 'blockNumber_DESC' | 'blockNumber_ASC_NULLS_FIRST' | 'blockNumber_DESC_NULLS_LAST' | 'blockTimestamp_ASC' | 'blockTimestamp_DESC' | 'blockTimestamp_ASC_NULLS_FIRST' | 'blockTimestamp_DESC_NULLS_LAST' | 'transactionHash_ASC' | 'transactionHash_DESC' | 'transactionHash_ASC_NULLS_FIRST' | 'transactionHash_DESC_NULLS_LAST' | 'to_ASC' | 'to_DESC' | 'to_ASC_NULLS_FIRST' | 'to_DESC_NULLS_LAST' | 'token_id_ASC' | 'token_id_DESC' | 'token_id_ASC_NULLS_FIRST' | 'token_id_DESC_NULLS_LAST' | 'token_tokenType_ASC' | 'token_tokenType_DESC' | 'token_tokenType_ASC_NULLS_FIRST' | 'token_tokenType_DESC_NULLS_LAST' | 'token_tokenAddress_ASC' | 'token_tokenAddress_DESC' | 'token_tokenAddress_ASC_NULLS_FIRST' | 'token_tokenAddress_DESC_NULLS_LAST' | 'token_tokenSubID_ASC' | 'token_tokenSubID_DESC' | 'token_tokenSubID_ASC_NULLS_FIRST' | 'token_tokenSubID_DESC_NULLS_LAST' | 'amount_ASC' | 'amount_DESC' | 'amount_ASC_NULLS_FIRST' | 'amount_DESC_NULLS_LAST' | 'fee_ASC' | 'fee_DESC' | 'fee_ASC_NULLS_FIRST' | 'fee_DESC_NULLS_LAST' | 'eventLogIndex_ASC' | 'eventLogIndex_DESC' | 'eventLogIndex_ASC_NULLS_FIRST' | 'eventLogIndex_DESC_NULLS_LAST';
    type UnshieldsConnection = {
    ...
    type NullifierOrderByInput = 'id_ASC' | 'id_DESC' | 'id_ASC_NULLS_FIRST' | 'id_DESC_NULLS_LAST' | 'blockNumber_ASC' | 'blockNumber_DESC' | 'blockNumber_ASC_NULLS_FIRST' | 'blockNumber_DESC_NULLS_LAST' | 'blockTimestamp_ASC' | 'blockTimestamp_DESC' | 'blockTimestamp_ASC_NULLS_FIRST' | 'blockTimestamp_DESC_NULLS_LAST' | 'transactionHash_ASC' | 'transactionHash_DESC' | 'transactionHash_ASC_NULLS_FIRST' | 'transactionHash_DESC_NULLS_LAST' | 'treeNumber_ASC' | 'treeNumber_DESC' | 'treeNumber_ASC_NULLS_FIRST' | 'treeNumber_DESC_NULLS_LAST' | 'nullifier_ASC' | 'nullifier_DESC' | 'nullifier_ASC_NULLS_FIRST' | 'nullifier_DESC_NULLS_LAST';
    type NullifiersConnection = {
    ...
    type TransactionOrderByInput = 'id_ASC' | 'id_DESC' | 'id_ASC_NULLS_FIRST' | 'id_DESC_NULLS_LAST' | 'blockNumber_ASC' | 'blockNumber_DESC' | 'blockNumber_ASC_NULLS_FIRST' | 'blockNumber_DESC_NULLS_LAST' | 'transactionHash_ASC' | 'transactionHash_DESC' | 'transactionHash_ASC_NULLS_FIRST' | 'transactionHash_DESC_NULLS_LAST' | 'merkleRoot_ASC' | 'merkleRoot_DESC' | 'merkleRoot_ASC_NULLS_FIRST' | 'merkleRoot_DESC_NULLS_LAST' | 'boundParamsHash_ASC' | 'boundParamsHash_DESC' | 'boundParamsHash_ASC_NULLS_FIRST' | 'boundParamsHash_DESC_NULLS_LAST' | 'hasUnshield_ASC' | 'hasUnshield_DESC' | 'hasUnshield_ASC_NULLS_FIRST' | 'hasUnshield_DESC_NULLS_LAST' | 'utxoTreeIn_ASC' | 'utxoTreeIn_DESC' | 'utxoTreeIn_ASC_NULLS_FIRST' | 'utxoTreeIn_DESC_NULLS_LAST' | 'utxoTreeOut_ASC' | 'utxoTreeOut_DESC' | 'utxoTreeOut_ASC_NULLS_FIRST' | 'utxoTreeOut_DESC_NULLS_LAST' | 'utxoBatchStartPositionOut_ASC' | 'utxoBatchStartPositionOut_DESC' | 'utxoBatchStartPositionOut_ASC_NULLS_FIRST' | 'utxoBatchStartPositionOut_DESC_NULLS_LAST' | 'unshieldToken_id_ASC' | 'unshieldToken_id_DESC' | 'unshieldToken_id_ASC_NULLS_FIRST' | 'unshieldToken_id_DESC_NULLS_LAST' | 'unshieldToken_tokenType_ASC' | 'unshieldToken_tokenType_DESC' | 'unshieldToken_tokenType_ASC_NULLS_FIRST' | 'unshieldToken_tokenType_DESC_NULLS_LAST' | 'unshieldToken_tokenAddress_ASC' | 'unshieldToken_tokenAddress_DESC' | 'unshieldToken_tokenAddress_ASC_NULLS_FIRST' | 'unshieldToken_tokenAddress_DESC_NULLS_LAST' | 'unshieldToken_tokenSubID_ASC' | 'unshieldToken_tokenSubID_DESC' | 'unshieldToken_tokenSubID_ASC_NULLS_FIRST' | 'unshieldToken_tokenSubID_DESC_NULLS_LAST' | 'unshieldToAddress_ASC' | 'unshieldToAddress_DESC' | 'unshieldToAddress_ASC_NULLS_FIRST' | 'unshieldToAddress_DESC_NULLS_LAST' | 'unshieldValue_ASC' | 'unshieldValue_DESC' | 'unshieldValue_ASC_NULLS_FIRST' | 'unshieldValue_DESC_NULLS_LAST' | 'blockTimestamp_ASC' | 'blockTimestamp_DESC' | 'blockTimestamp_ASC_NULLS_FIRST' | 'blockTimestamp_DESC_NULLS_LAST' | 'verificationHash_ASC' | 'verificationHash_DESC' | 'verificationHash_ASC_NULLS_FIRST' | 'verificationHash_DESC_NULLS_LAST';
    ...
    type VerificationHashWhereInput = {
        id_isNull?: InputMaybe<Scalars['Boolean']>;
        id_eq?: InputMaybe<Scalars['String']>;
        id_not_eq?: InputMaybe<Scalars['String']>;
        id_gt?: InputMaybe<Scalars['String']>;
    ...
    type VerificationHashOrderByInput = 'id_ASC' | 'id_DESC' | 'id_ASC_NULLS_FIRST' | 'id_DESC_NULLS_LAST' | 'verificationHash_ASC' | 'verificationHash_DESC' | 'verificationHash_ASC_NULLS_FIRST' | 'verificationHash_DESC_NULLS_LAST';
    type VerificationHashesConnection = {
        edges: Array<VerificationHashEdge>;
        pageInfo: PageInfo;
        totalCount: Scalars['Int'];
    };
    type VerificationHashEdge = {
        node: VerificationHash;
        cursor: Scalars['String'];
    };
    type CommitmentBatchEventNew = {
        id: Scalars['String'];
        treeNumber: Scalars['BigInt'];
        batchStartTreePosition: Scalars['BigInt'];
    };
    type CommitmentBatchEventNewWhereInput = {
        id_isNull?: InputMaybe<Scalars['Boolean']>;
        id_eq?: InputMaybe<Scalars['String']>;
        id_not_eq?: InputMaybe<Scalars['String']>;
        id_gt?: InputMaybe<Scalars['String']>;
    ...
    type CommitmentBatchEventNewOrderByInput = 'id_ASC' | 'id_DESC' | 'id_ASC_NULLS_FIRST' | 'id_DESC_NULLS_LAST' | 'treeNumber_ASC' | 'treeNumber_DESC' | 'treeNumber_ASC_NULLS_FIRST' | 'treeNumber_DESC_NULLS_LAST' | 'batchStartTreePosition_ASC' | 'batchStartTreePosition_DESC' | 'batchStartTreePosition_ASC_NULLS_FIRST' | 'batchStartTreePosition_DESC_NULLS_LAST';
    type CommitmentBatchEventNewsConnection = {
        edges: Array<CommitmentBatchEventNewEdge>;
        pageInfo: PageInfo;
        totalCount: Scalars['Int'];
    };
    type CommitmentBatchEventNewEdge = {
