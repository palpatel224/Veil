...
export type CiphertextOrderByInput = 'id_ASC' | 'id_DESC' | 'id_ASC_NULLS_FIRST' | 'id_DESC_NULLS_LAST' | 'iv_ASC' | 'iv_DESC' | 'iv_ASC_NULLS_FIRST' | 'iv_DESC_NULLS_LAST' | 'tag_ASC' | 'tag_DESC' | 'tag_ASC_NULLS_FIRST' | 'tag_DESC_NULLS_LAST';
...
export type VerificationHashOrderByInput = 'id_ASC' | 'id_DESC' | 'id_ASC_NULLS_FIRST' | 'id_DESC_NULLS_LAST' | 'verificationHash_ASC' | 'verificationHash_DESC' | 'verificationHash_ASC_NULLS_FIRST' | 'verificationHash_DESC_NULLS_LAST';
...
export declare function getBuiltGraphSDK<TGlobalContext = any, TOperationContext = any>(globalContext?: TGlobalContext): {
    GetRailgunTransactionsAfterGraphID(variables?: Exact<{
        idLow?: InputMaybe<string> | undefined;
    }> | undefined, options?: TOperationContext | undefined): Promise<GetRailgunTransactionsAfterGraphIDQuery>;
    GetRailgunTransactionsByTxid(variables?: Exact<{
        txid?: InputMaybe<string> | undefined;
    }> | undefined, options?: TOperationContext | undefined): Promise<GetRailgunTransactionsByTxidQuery>;
    GetRailgunTransactionsByUnshieldToAddress(variables?: Exact<{
        address?: InputMaybe<string> | undefined;
    }> | undefined, options?: TOperationContext | undefined): Promise<GetRailgunTransactionsByUnshieldToAddressQuery>;
};
...
export type GetRailgunTransactionsAfterGraphIDQuery = {
    transactions: Array<(Pick<Transaction, 'id' | 'nullifiers' | 'commitments' | 'transactionHash' | 'boundParamsHash' | 'blockNumber' | 'utxoTreeIn' | 'utxoTreeOut' | 'utxoBatchStartPositionOut' | 'hasUnshield' | 'unshieldToAddress' | 'unshieldValue' | 'blockTimestamp' | 'verificationHash'> & {
...
export declare const GetRailgunTransactionsAfterGraphIDDocument: DocumentNode<GetRailgunTransactionsAfterGraphIDQuery, Exact<{
    idLow?: InputMaybe<string> | undefined;
}>>;
export declare const GetRailgunTransactionsByTxidDocument: DocumentNode<GetRailgunTransactionsByTxidQuery, Exact<{
    txid?: InputMaybe<string> | undefined;
}>>;
export declare const GetRailgunTransactionsByUnshieldToAddressDocument: DocumentNode<GetRailgunTransactionsByUnshieldToAddressQuery, Exact<{
    address?: InputMaybe<string> | undefined;
}>>;
